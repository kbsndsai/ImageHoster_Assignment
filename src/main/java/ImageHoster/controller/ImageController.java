...
public class ImageController {
    ...
    //The image is now retrieved using the id of the image not by title
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        //The current user is being comapred with the user who posted the image. If the user is same then it enables the Edit option else it displays the error message

        if(user.equals(img.getUser())) {
            Image image = imageService.getImage(imageId);
